    ...
    onLoad(waiting) {
      ...
      if (this.book.content) {
        ...
        if (this.value.text.length == 1 && el.children.length) {
          let txt = el.children.filter((item) => item.item.innerText).map((item) => item.innerText.trim()).filter((item) => item);
          if (txt.length) {
            this.value.text = txt;
          }
        }
        if (!this.value.text.length) {
          if (Date.now() - this.now < 1e4) {
            setTimeout(this.onLoad, 1e3);
...
const _hoisted_1$1 = ["data-load-times", "src"];
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return $data.isLoad && $props.value.url ? (openBlock(), createElementBlock("iframe", {
    key: 0,
    "data-load-times": $data.loadTimes,
    src: $props.value.url,
    onLoad: _cache[0] || (_cache[0] = ($event) => $options.onLoad(true)),
    class: "iframe",
    frameborder: "0"
  }, null, 40, _hoisted_1$1)) : createCommentVNode("", true);
}
var Content = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-3343a777"]]);
...
const _sfc_main = {
  ...
  methods: {
    ...
    downloadJson() {
      ...
      FileSaver_min.exports.saveAs(blob, `${this.book.name}.json`);
    },
    downloadText() {
      var text = this.book.chapters.map((item) => item.name + "\n\n" + (item.text || []).map((x) => "\u3000\u3000" + x).join("\n\n")).join("\n\n\n");
      var blob = new Blob([text], { type: "text/plain;charset=utf-8" });
      FileSaver_min.exports.saveAs(blob, `${this.book.name}.txt`);
    }
  },
  mounted() {
  }
};
const _withScopeId = (n) => (pushScopeId("data-v-404e82c0"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "hackbook" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h2", null, "\u91C7\u96C6\u8BBE\u7F6E", -1));
const _hoisted_3 = { class: "item" };
const _hoisted_4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "\u4E66\u540D\uFF1A", -1));
const _hoisted_5 = { class: "item" };
const _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "\u7F51\u5740\uFF1A", -1));
const _hoisted_7 = { class: "item" };
const _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "\u7AE0\u8282\uFF1A", -1));
const _hoisted_9 = { class: "item" };
const _hoisted_10 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "\u5185\u5BB9\uFF1A", -1));
const _hoisted_11 = { class: "process" };
const _hoisted_12 = { style: { "display": "none" } };
const _hoisted_13 = { class: "item" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Content = resolveComponent("Content");
  return openBlock(), createElementBlock("div", _hoisted_1, [
    $data.step == 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
      _hoisted_2,
      createBaseVNode("label", _hoisted_3, [
        _hoisted_4,
        withDirectives(createBaseVNode("input", {
          type: "text",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.book.name = $event)
        }, null, 512), [
          [vModelText, $data.book.name]
        ])
      ]),
      createBaseVNode("label", _hoisted_5, [
        ...
        withDirectives(createBaseVNode("input", {
          type: "text",
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.book.url = $event),
          placeholder: "http://"
        }, null, 512), [
          [vModelText, $data.book.url]
        ])
      ]),
      createBaseVNode("label", _hoisted_7, [
        ...
        withDirectives(createBaseVNode("input", {
          type: "text",
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.book.chapter = $event),
          placeholder: "\u6B63\u5728\u8868\u8FBE\u5F0F"
        }, null, 512), [
          [vModelText, $data.book.chapter]
        ])
      ]),
      createBaseVNode("label", _hoisted_9, [
        ...
        withDirectives(createBaseVNode("input", {
          type: "text",
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.book.content = $event),
          placeholder: "\u6B63\u5728\u8868\u8FBE\u5F0F"
        }, null, 512), [
          [vModelText, $data.book.content]
        ])
      ]),
      createBaseVNode("button", {
        class: "item",
        onClick: _cache[4] || (_cache[4] = (...args) => $options.collect && $options.collect(...args))
      }, "\u5F00\u59CB\u91C7\u96C6")
    ], 64)) : createCommentVNode("", true),
    $data.testContent ? (openBlock(), createBlock(_component_Content, {
      key: 1,
      value: $data.testContent,
      book: $data.book
    }, null, 8, ["value", "book"])) : $data.step == 1 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
      createBaseVNode("div", _hoisted_11, [
        createBaseVNode("div", {
          class: "value",
          style: normalizeStyle($options.processWidth)
        }, null, 4),
        createBaseVNode("div", _hoisted_12, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.hackChapters, (item) => {
            return openBlock(), createBlock(_component_Content, {
              key: item.url,
              value: item,
              book: $data.book,
              onClose: ($event) => {
            ...
            }, null, 8, ["value", "book", "onClose"]);
          }), 128))
        ])
      ]),
      createBaseVNode("div", _hoisted_13, [
        createBaseVNode("button", {
          onClick: _cache[5] || (_cache[5] = ($event) => $options.downloadJson())
        }, "\u4E0B\u8F7D\u7ED3\u6784\u6570\u636E"),
        createBaseVNode("button", {
          onClick: _cache[6] || (_cache[6] = ($event) => $options.downloadText())
        }, "\u4E0B\u8F7D\u7EAF\u6587\u672C")
      ])
    ], 64)) : createCommentVNode("", true)
  ]);
}
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-404e82c0"]]);
